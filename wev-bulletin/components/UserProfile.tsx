...
export default function UserProfile({
  ...
  if (loading) {
    return <div className="h-10 w-10 rounded-full bg-border animate-pulse" />;
  }
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-48 bg-card border border-border rounded-wev-card z-50 shadow-wev-dropdown transition-all duration-700 ease-in-out">
            <div className="p-4 border-b border-border transition-colors duration-700 ease-in-out">
              <p className="text-sm text-foreground font-semibold truncate transition-colors duration-700 ease-in-out">
                {user.email}
              </p>
              <p className="text-xs text-wev-text-tertiary mt-1 transition-colors duration-700 ease-in-out">
