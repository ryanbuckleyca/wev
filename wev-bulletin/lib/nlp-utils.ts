export const STOP_WORDS = new Set([
  ...
  'by', 'at', 'is', 'be', 'as', 'it', 'its', 'their', 'that', 'this',
  'from', 'each', 'other', 'use', 'using', 'used', 'manage', 'apply',
  'ensure', 'develop', 'create', 'provide', 'support', 'work',
  // French
  'un', 'une', 'le', 'la', 'les', 'et', 'ou', 'de', 'du', 'des', 'dans',
  'à', 'au', 'aux', 'pour', 'sur', 'avec', 'par', 'est', 'être', 'comme',
  'il', 'elle', 'son', 'sa', 'ses', 'leur', 'leurs', 'ce', 'cette', 'ces',
  'qui', 'que', 'quoi', 'dont', 'où', 'utiliser', 'utilisation', 'gérer',
  'appliquer', 'assurer', 'développer', 'créer', 'fournir', 'soutenir', 'travail',
]);
