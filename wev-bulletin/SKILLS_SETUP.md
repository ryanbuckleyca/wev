...
- **2-Stage Pipeline**:
  ...
  2. **LLM Selection**: Send shortlist to Groq (llama-3.1-70b-versatile), get final max 10 skills
- **Benefits**:
...
- **Groq Model**: Using `llama-3.1-70b-versatile` (fast, accurate, cost-effective)
