...
describe('BulletinPageView', () => {
  it('wires listing and admin action props from hook state', async () => {
    ...
    render(<BulletinPageView isAdmin isLoggedIn profile={null} filters={filters} data={data} skillLabels={{}} />);
  ...
  it('hides admin actions and match sorting when no user context is available', () => {
    ...
    render(<BulletinPageView isAdmin={false} isLoggedIn={false} profile={null} filters={filters} data={data} skillLabels={{}} />);
