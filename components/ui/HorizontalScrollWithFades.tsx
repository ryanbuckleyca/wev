...
function EdgeFade({
  ...
  return (
    <div className={`pointer-events-none absolute inset-y-0 ${isLeft ? 'left-0' : 'right-0'} z-10 w-16`}>
      <div
...
export default function HorizontalScrollWithFades({
  ...
  return (
    <div className={`relative ${containerClassName}`}>
      <EdgeFade direction="left" visible={fades.left} tabbable={chevronsTabbable} fadeBackground={fadeBackground} onScroll={scrollBy} />
      <div
        ref={ref}
      ...
      <EdgeFade direction="right" visible={fades.right} tabbable={chevronsTabbable} fadeBackground={fadeBackground} onScroll={scrollBy} />
    </div>
  )
}
