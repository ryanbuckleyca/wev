...
export default function ReScrapeButton({ onComplete }: ReScrapeButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="px-6 py-2.5 bg-wev-primary text-white border-2 border-wev-primary rounded-wev-btn font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
    >
      {loading ? (
